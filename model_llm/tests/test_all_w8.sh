...
models=("pretrained=/data01/home/xuzk/datasets/lm_mamba_weight/mamba-130m-hf" \
        ...
        "pretrained=/data01/home/xuzk/datasets/lm_mamba_weight/mamba-1.4b-hf" \
        "pretrained=/data01/home/xuzk/datasets/lm_mamba_weight/mamba-2.8b-hf")

for model in "${models[@]}"; do
    # for task in "${tasks[@]}"; do
    #     echo "model: $model, task: $task, w8a8_method_0.5"
    ...
    # for task in "${tasks[@]}"; do
    #     echo "model: $model, task: $task, w8a8_method_1"
    #     /data01/home/xuzk/anaconda3/envs/mamba-nd/bin/python tests/quant_naive.py \
    #         --model mamba \
    #         --model_args "$model" \
    #         --tasks "$task" \
    ...
    # done
        for task in "${tasks[@]}"; do
        echo "model: $model, task: $task, w8a8_method_1.5"
        /data01/home/xuzk/anaconda3/envs/mamba-nd/bin/python tests/quant_naive.py \
            --model mamba \
            --model_args "$model" \
            --tasks "$task" \
    ...
    for task in "${tasks[@]}"; do
        echo "model: $model, task: $task, w8a8_method_2"
        /data01/home/xuzk/anaconda3/envs/mamba-nd/bin/python tests/quant_naive.py \
            --model mamba \
            --model_args "$model" \
            --tasks "$task" \
