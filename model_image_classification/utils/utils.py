...
def convert_vim_2_vim_torch(model,device):
    ...
    linear = nn.Linear(3 * model.patch_embed.projection.kernel_size[0]**2, 
    ...
    model.ln1 = model.ln1.to(linear.weight.data)
    model.ln2 = model.ln2.to(linear.weight.data)

from timm.utils import accuracy
@torch.no_grad()
def evaluate(data_loader, model, device, amp_autocast, eval_len=9999999):
